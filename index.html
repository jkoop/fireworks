...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Hanabi network multiplayer and card logic">
    ...
    <body>
        ...
        <form onsubmit="return false" id="thisCardIs">
            ...
            <p>
                <label>
                    <input type="radio" id="couldBe" name="couldBe" value="couldBe" />
                    Can be (among other things)
                </label><br>
                <label>
                    <input type="radio" id="couldBeOnly" name="couldBe" value="couldBeOnly" checked />
                    Can only be
                </label>
            </p>
            <p>
        ...
        <hr />
        <address>Fireworks - <a href="https://github.com/jkoop/fireworks">GitHub</a></address>
    </body>
</html>
